  ...
  <div class="max-w-7xl  mx-auto mt-5">
    <div class="max-w-2xl mx-auto rounded p-4">
        <form action="/listings/store" class="text-laraDark" method="POST">
            @csrf
            <div class="mb-3">
                <label for="title" class="text-xl font-semibold block mb-1">Title</label>
            ...
            <div class="mb-3">
                <label for="tags" class="text-xl font-semibold block mb-1">Tags</label>
            ...
            <div class="mb-3">
                <label for="company" class="text-xl font-semibold block mb-1">Company</label>
            ...
            <div class="mb-3">
                <label for="location" class="text-xl font-semibold block mb-1">Location</label>
            ...
            <div class="mb-3">
                <label for="email" class="text-xl font-semibold block mb-1">Email</label>
            ...
            <div class="mb-3">
                <label for="website" class="text-xl font-semibold block mb-1">Website</label>
